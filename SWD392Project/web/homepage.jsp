...
<head>
    ...
    <title>Trang Chủ - SWD392 Project</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <p>Chào mừng bạn đến với SWD392 Project</p>
    </div>

    <div class="nav">
        <a href="homepage.jsp">Trang Chủ</a>
        <a href="procedures">Thủ Tục</a>
...
<!--            <a href="signup.jsp">Đăng Ký</a>-->
        <% } else { %>
            <span class="user-info">Xin chào, <%= session.getAttribute("user") %> |</span>
        ...
        <div class="procedures">
            ...
            <c:forEach var="procedure" items="${proceduresList}">
                <div class="procedure-item">
                    ...
                    <a href="procedureDetails?id=${procedure.procedureId}">Xem chi tiết</a>
                </div>
            </c:forEach>
        </div>
