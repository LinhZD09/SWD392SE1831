 ...
 * @author MSI
 */
@WebServlet(name="ApproveSubmissionServlet", urlPatterns={"/approve-submission"})
public class ApproveSubmissionServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ApproveSubmissionServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ApproveSubmissionServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
